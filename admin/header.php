  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<h4 style="color: white">Philip and Aurea Residences</h4>
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<h4 style="color: white">P&A</h4>
					</a>
                </div>
				<!-- /Logo -->
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="payment.php"><i class="fe fe-money"></i> <span> Payments</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    ...
                                    <li><a href="feedbackviewpositive.php"> Positive </a></li>
                                    <li><a href="feedbackviewnegative.php"> Negative </a></li>
                                    <li><a href="feedbackviewneutral.php"> Neutral </a></li>
                                </ul>
                            </li>
                            ...
                            <li class="submenu">
                                <a href="messages.php"><i class="fe fe-messanger"></i> <span> Messages</span> <span class="menu-arrow"></span></a>
                                <ul style="display: none;">
                            ...
                            <li class="submenu">
                                <a href="messages.php"><i class="fe fe-calendar"></i> <span> Schedules</span> <span class="menu-arrow"></span></a>
                                <ul style="display: none;">
                                    <li><a href="calendar.php"> View Event Schedules</a></li>
                            ...
                            <li class="submenu">
                                <a href="#"><i class="fe fe-file"></i> <span> Documents </span> <span class="menu-arrow"></span></a>
                                <ul style="display: none;">
                                    <li><a href="documentAdd.php"> Add Document </a></li>
                                    <li><a href="documentview.php"> View Documents </a></li>
                                </ul>
                            </li>
                            <li class="menu-title">
                                <span>About</span>
