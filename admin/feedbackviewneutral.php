            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Neutral Feedback</h3>
								<ul class="breadcrumb">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Neutral Feedback List</h4>
								...
								<div class="card-body">
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											<?php
												...
												$query=mysqli_query($con,"select feedback.*, user.* from feedback,user where feedback.uid=user.uid AND sentiment LIKE '%Neutral%'");
												$cnt=1;
											...
											?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p style="padding: 7px; border-radius: 5px; color: white; text-align: center; background-color: gray; ?>"><?php echo $row['sentiment']; ?></p>
                                                    </td>
