												...
												while($row=mysqli_fetch_array($query))
													{
														...
														} elseif (trim($row['sentiment']) == 'Negative') {
															$backgroundColor = 'background-color: red; color: white;';
														} elseif (trim($row['sentiment']) == 'Neutral') {
															$backgroundColor = 'background-color: gray; color: white;';
														}
											?>
                                                <tr>
                                                    <td><?php echo $cnt; ?></td>
                                                    ...
                                                    <td>
														<p style="<?php echo $backgroundColor; ?> padding: 5px; border-radius: 5px; text-align: center;">
