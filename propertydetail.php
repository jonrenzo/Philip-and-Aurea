...
<!-- Meta Tags -->
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Philip and Aurea Residences">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="text-primary text-left h5 my-2 text-md-right">₱<?php echo number_format($row['13']);?></div>
                        ...
                        <div class="myFlex">
                            <button onclick="toReqTour()">Request a tour</button>
                            <button onclick="toContact()" id="myContact">Contact Us</button>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="amount" value="<?php echo $row['13']?>" required >
