...
<div id="page-wrapper">
    ...
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/bannerrealestate.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4" style="text-align: center; font-size: 4rem;">Discover Your New Home</h1>
                            <form method="post" action="propertygrid.php">
                                <div class="row" style="display: flex; justify-content: center;">
                                    ...
                                    <div class="col-md-8 col-lg-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="city" placeholder="Enter an address, neighborhood, or city" required>
                                        </div>
                                    </div>
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">See How Philip and Aurea Residences Can Help</h2>
                    </div>
                </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Room Types</h2>
                    </div>
                    <!--- <div class="col-md-6">
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
									...
									<?php $query=mysqli_query($con,"SELECT * FROM `property` WHERE status = 'available' ORDER BY date DESC LIMIT 9");
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative" style="max-height: 200px;"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price" style="color: white;"><b>₱<?php echo number_format($row['13']); ?> </b><span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
                                            </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>WWe are proud to be top-rated by our clients and industry experts alike, reflecting our commitment to excellence. Each service is delivered with care and dedication, ensuring you get the best experience every time.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Quality is at the heart of what we do. We go above and beyond to provide reliable, premium services tailored to exceed your expectations..</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of seasoned agents brings years of expertise and dedication. You can trust us to understand your needs and deliver exceptional service with confidence.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We start by understanding your needs through an in-depth discussion. This helps us align our approach with your goals for a tailored experience.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Next, we conduct a thorough review of all relevant files to ensure every detail is considered. This step guarantees accuracy and a complete understanding of your requirements.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once everything is confirmed, you can confidently acquire our services. We handle the rest, ensuring a smooth and efficient process from start to finish.</p>
                        </div>
                    </div>
                </div>
            </div>
						...
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-primary my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Rent Property</div>
                            </div>
                        </div>
                        <div class="col-md-3">
